package com.csii.ants.management.generator.enums;

import com.csii.ants.management.server.enums.*;
...
//    static String path = "web\\public\\static\\js\\enums.js";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            toJson(NationalityEnum.class, bufferObject, bufferArray);
            toJson(AnnouncementTypeEnum.class, bufferObject, bufferArray);
