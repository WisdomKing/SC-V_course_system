              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select v-model="clockin.manhourType" class="form-control">
                    <option v-for="o in MANHOURTYPE" v-bind:value="o.key">{{o.value}}</option>
                  </select>
                </div>
              </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select v-model="clockin.status" class="form-control">
                      <option v-for="o in CLOCKIN" v-bind:value="o.key">{{o.value}}</option>
                    </select>
                  </div>
                </div>
            </form>
