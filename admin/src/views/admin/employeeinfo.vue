<template>
  <div>
    <!-- 刷新按钮 -->
    <p>
    <button v-show="hasResource('040201')" v-on:click="add()" class="btn btn-white btn-default btn-round">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="hidden-sm hidden-xs btn-group">
            <button v-show="hasResource('040201')" v-on:click="edit(scope.row)" class="btn btn-xs btn-info">
              <!--详情-->
              <i class="ace-icon fa fa-pencil bigger-120"></i>
            </button>
            <button v-show="hasResource('040202')" v-on:click="del(scope.row.id)" class="btn btn-xs btn-danger">
